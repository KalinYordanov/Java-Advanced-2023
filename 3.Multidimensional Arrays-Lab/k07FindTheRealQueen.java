...
public class k07FindTheRealQueen {
    public static void main(String[] args) {
        ...
        for (int row = 0; row < size; row++) {
            ...
            chessBoard[row] = string.toCharArray();
    ...
    private static int[] getIndexByRow(char[][] chessBoard) {
        ...
        while (row < chessBoard.length) {
            ...
            if (counter == 1) {
                ...
                boolean searchInDiagonals = searchInDiagonals(chessBoard, index);
                if (isOneQueenInColumn && searchInDiagonals) {
                    return index;
                }
            }
            row++;
